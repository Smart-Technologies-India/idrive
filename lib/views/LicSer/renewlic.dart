...
class RenewLic extends HookWidget {
  const RenewLic({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    padding:
                        const EdgeInsets.only(left: 15, top: 20, bottom: 10),
                    child: const Text("Date of Expiry"),
                  ),
                  Container(
                    margin: const EdgeInsets.only(left: 10, right: 10),
                    child: ClipRRect(
                        ...
                        onPressed: () async {
                          if (licNo.text == "") {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text("Please Fill the Licene Number"),
                              ),
                            );
                          } else if (doe.text == "") {
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content:
                                        Text("Please Enter Date of Expiry")));
